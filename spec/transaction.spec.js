...
describe('Transaction', () => {
    ...
    describe('Constructor', () => {
        it('should create a transaction object with the provided date, deposit amount, and withdrawal amount', () => {
            // Arrange
            const date = '2012-01-14'; // cannot be 14/01/2012, because in js the Date constructor expects the date string to be in ISO 8601 format (e.g., 'YYYY-MM-DD').
